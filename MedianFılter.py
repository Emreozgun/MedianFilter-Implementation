...
def bitMix_ordering(pixels,centerRgb,kernelSize) : # 2 tane parametre alıcak pixel_1 ve pixel_2 
...
def norm_based_ordering(pixels,centerRgb,kernelSize) :  #distance fonksiyonunu kullanmadan euclideanı bul 
...
def scalar_median_filter(image,kernelSize,f) : # marginal
	...
	saveName = "Results/" + f + "_scalar_.png"
...
def vector_median_filter(image,kernelSize,func,f) : # marginal
	...
	saveName = "Results/" + f + "_vector_" + func.__name__ + ".png"
